...
{
    public class BlackMesaDeathmatch_Classes
    {
        //===================================================================================//
        ...
        {
            ExternalExecution_Classes.LaunchExternalProgram(DestinationFolder + @"\steamcmd.exe", "+login anonymous +app_update 346680 +quit", false);
        }
