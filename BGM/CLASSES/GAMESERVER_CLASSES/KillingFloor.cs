...
{
    public class KillingFloor_Classes
    {
        //===================================================================================//
        ...
        {
            ExternalExecution_Classes.LaunchExternalProgram(DestinationFolder + @"\steamcmd.exe", "+login anonymous +app_update 215350 +quit", false);
        }
