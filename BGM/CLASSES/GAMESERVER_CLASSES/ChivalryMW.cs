...
{
    public class ChivalryMW_Classes
    {
        //===================================================================================//
        ...
        {
            ExternalExecution_Classes.LaunchExternalProgram(DestinationFolder + @"\steamcmd.exe", "+login anonymous +app_update 220070 +quit", false);
        }
